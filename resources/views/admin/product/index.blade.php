...
@section('title')
{{trans('sidebar.product')}} {{trans('common.list')}}
@endsection
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                ...
                <h5>{{trans('sidebar.product')}} {{trans('common.list')}}</h5>
                </div>
            ...
            <div class="m-portlet__body">
             ...
             <div class="m-form m-form--label-align-right  m--margin-bottom-30">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="m-input-icon m-input-icon--left">
                         <input type="text" class="form-control input-circle-right m-input" placeholder="Search..." id="search-box"> 
                    ...
                    <div class="col-xl-6 col-md-6">
                        <a  href="{{URL::to('admin/product/create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill float-right mt-1">
                            <span>
                                <i class="fa fa-user-plus"></i>
                                <span>
                                    {{trans('common.new')}} {{trans('sidebar.product')}}
                                </span>
                            </span>
                        </a>
                    </div>
                ...
                <!--begin: Datatable -->
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded" id="product-list"> 
...
<script type="text/javascript">
    $(document).ready(function() 
    {
       ...
       function getProduct(qstring)
       {   
         $.ajax({
             type: 'GET',
             url : basePath+'/product?' + qstring,
             dataType: 'json',
         }).done(function (data) 
         {
