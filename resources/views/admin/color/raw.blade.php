...
<table width="100%" class="m-dt-table table table-bordered table-hover" id="html_table">
    <thead class="m-datatable__head">
        ...
        <th>{{trans('sidebar.color')}} {{trans('user.name')}} </th>
        <th>{{trans('sidebar.color')}}</th>
    ...
    <tbody class="m-datatable__body">
        @forelse($lists as $row) 
            <tr class="m-datatable__row">
                ...
                <td><div class="circle" style="background-color: {{$row->value}}"></div></td>
                <td><img src="{{URL::to('public'.config('admin.image.color').$row->image)}}"  width="15%" height="15%"></td>  
                ...
                <td><a href="{{ URL::to('admin/color/'.$row->id.'/edit') }}"><i class="fa fa-pencil"></i></a> &nbsp; <a href="#" class="delete" data-id="{{$row->id}}"> <i class="fa fa-times-circle-o"></i></a></td>                                          
            </tr>
        @empty
        <tr class="odd gradeX">
