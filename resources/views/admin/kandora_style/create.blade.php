...
@section('title')
{{trans('common.create')}} {{trans('sidebar.kandora_style')}}
@endsection
@section('css')
    ...
    <div class="m-content">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
               ...
               {{  Form::open(array('url'=>'admin/kandora-style/' , 'method' =>'POST','class'=>'m-form m-form--fit m-form--label-align-right','files'=>'true'))}}
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group m-form__group row">
                                ...
                                {{ Form::text('title','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' '.trans('sidebar.kandora_style').' '.trans('user.title')))}}
