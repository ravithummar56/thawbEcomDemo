...
@section('title')
{{trans('common.create')}} {{trans('sidebar.user')}} 
@endsection
@section('css')
    ...
    <div class="m-content">
        <div class="col-md-6">
            <div class="m-portlet m-portlet--mobile">
               ...
               {{  Form::open(array('url'=>'admin/users/' , 'method' =>'POST','class'=>'m-form m-form--fit m-form--label-align-right','files'=>'true'))}}
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group m-form__group row">
                                ...
                                {{ Form::text('first_name','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('user.first_name')))}}
                             ...
                             <div class="form-group m-form__group row">
                                ...
                                {{ Form::text('last_name','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('user.last_name')))}}
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                               {{ Form::text('email','',array('class'=>'form-control m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('login.email')))}}
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                               {{ Form::password('password',array('class'=>'form-control m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('login.password')))}}
                               <span class="m-form__help" style="color: red">{{ $errors->first('password') }}</span>
                                </div>
                            </div>
