...
@section('title')
{{trans('sidebar.request_trailer')}} {{trans('common.list')}}
@endsection
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                ...
                <h5>{{trans('sidebar.request_trailer')}} {{trans('common.list')}}</h5>
                </div>
            ...
            <div class="m-portlet__body">
             ...
             <div class="m-form m-form--label-align-right  m--margin-bottom-30">
                ...
                <!--begin: Datatable -->
                <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded" id="request-trailer-list"> 
...
<script type="text/javascript">
    $(document).ready(function() 
    {
       ...
       {   
         $.ajax({
             type: 'GET',
             url : basePath+'/request-trailer?' + qstring,
             dataType: 'json',
         }).done(function (data) 
         {
            $('#request-trailer-list').html(data);     
         }).fail(function () {
      ...
      $(document).on('click','.delete-user-record',function(e){
               ...
               var _token = "{{ csrf_token() }}";
                 ...
                 $.ajax({
                       url: baseUrl +'/request-trailer/'+id ,
                       type: 'DELETE',  
                       data:{_token:_token},
