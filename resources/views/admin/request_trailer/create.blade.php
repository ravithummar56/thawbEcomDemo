...
@section('title')
{{trans('common.create')}} {{trans('sidebar.promotionCode')}} 
@endsection
@section('css')
    ...
    <div class="m-content">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
               ...
               {{  Form::open(array('url'=>'admin/promotion-code/' , 'method' =>'POST','class'=>'m-form m-form--fit m-form--label-align-right','files'=>'true'))}}
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group m-form__group row">
                                ...
                                {{ Form::text('title','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('promotion_code.title')))}}
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                {{ Form::text('code','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('promotion_code.code')))}}
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                {{ Form::number('limit','',array('class'=>'form-control form-control-danger m-input','data-required'=>'1','placeholder'=> trans('common.enter').' ' .trans('promotion_code.limit')))}}
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="text" readonly class="form-control" name="start_date" id="m_datepicker_1" readonly placeholder="Select date"/>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="text" readonly class="form-control" name="end_date" id="m_datepicker_1" readonly placeholder="Select date"/>
